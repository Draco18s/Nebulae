...
public class BGNebDetail : MonoBehaviour {
	public Transform t1;
	public Transform t2;
	public Transform t3;
	public Transform t4;
	...
	public void setupTransforms() {
		...
		this.transform.position+= new Vector3(randRange(-2f,2f),randRange(-2f,2f),0);
		this.transform.localScale=Vector3.one*(Random.value*1.5f + .75f);
		...
		t1.localPosition=new Vector3(randRange(-3f,3f),randRange(-2f,2f),0);
		t2.localPosition=new Vector3(randRange(-3f,3f),randRange(-2f,2f),0);
		t3.localPosition=new Vector3(randRange(-10f,10f),randRange(-10f,10f),0);
		t4.localPosition=new Vector3(randRange(-10f,10f),randRange(-6f,6f),0);
		
		float sc= Random.value*2+.75f;
		t1.localScale=new Vector3(sc,sc*(1+randPM(.35f)),1);
		sc = Random.value*2+.75f;
